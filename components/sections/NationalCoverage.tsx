      ...
      <div className="container mx-auto px-6 relative z-10 py-12">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
             ...
             <span className="font-mono text-[10px] md:text-xs tracking-[0.4em] uppercase text-red-200/60">
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-8 text-white drop-shadow-2xl"
          >
            ABRANGÊNCIA <br className="md:hidden" />
            <span className="md:ml-4 text-transparent bg-clip-text bg-gradient-to-br from-white via-red-500 to-red-900">
                NACIONAL
            </span>
          </motion.h2>
          ...
          <motion.p 
            ...
            className="text-lg md:text-2xl text-gray-300 font-light leading-relaxed max-w-3xl mb-12"
          >
