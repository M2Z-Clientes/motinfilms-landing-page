...
export function Solutions() {
  const solutions = [
    ...
    },
    {
      ...
      subtitle: 'SCENE 02 - COMMERCIAL',
      description: 'Destaque seus produtos de maneira única no mercado, expondo seus diferenciais técnicos e impulsionando vendas diretas.',
      icon: <Package className="w-6 h-6 md:w-8 md:h-8" />,
    },
    {
      title: 'Filme Evento Corporativo',
      subtitle: 'SCENE 03 - COVERAGE',
    ...
    },
    {
      ...
      subtitle: 'SCENE 04 - SOCIAL',
      description: 'Dê voz à sua marca nas redes sociais com conteúdos estratégicos (Reels/TikTok) que informam, conectam e geram autoridade.',
      icon: <Smartphone className="w-6 h-6 md:w-8 md:h-8" />,
    },
    {
      title: 'Filmes Case',
      subtitle: 'SCENE 05 - PROOF',
    ...
    },
    {
      ...
      subtitle: 'SCENE 06 - CAMPAIGN',
      description: 'Divulgue suas campanhas promocionais e ações com vídeos de alta energia que geram engajamento e atraem novos clientes.',
      ...
      <div className="container mx-auto max-w-7xl relative z-20 px-4 md:px-8">
        ...
        <div className="mb-16 md:mb-24">
            <div className="flex items-center gap-4 mb-6 md:mb-8 opacity-70">
                ...
                <span className="font-mono text-[10px] md:text-xs tracking-[0.2em] md:tracking-[0.3em] text-gray-400 uppercase">
                    Service Catalog
                </span>
            </div>

            {/* AQUI ESTAVA O PROBLEMA: "items-end" estava forçando alinhamento à direita no mobile */}
            {/* CORREÇÃO: "items-start" (mobile) md:items-end (desktop) */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white max-w-2xl leading-tight text-left">
                    TIPOS DE <br />
                    <CinematicText text="SOLUÇÕES" className="text-white" />
                </h2>
                <p className="text-gray-400 max-w-md text-sm md:text-base leading-relaxed border-l border-white/10 pl-6 pb-2 text-left">
                    Oferecemos um leque completo de soluções audiovisuais para impulsionar sua marca.
                </p>
            </div>
        </div>

        {/* --- GRID (Storyboard Style) --- */}
            ...
            {solutions.map((item, idx) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-6">
                      ...
                      <span className="font-mono text-[9px] md:text-[10px] text-gray-500 border border-white/10 px-2 py-1 rounded bg-black/20 whitespace-nowrap ml-2 group-hover:border-red-500/30 group-hover:text-red-400 transition-colors">
                          {item.subtitle}
                      </span>
                  </div>

                  <h3 className="font-mono text-lg md:text-xl text-white mb-3 tracking-tight group-hover:text-red-400 transition-colors">
                      {item.title}
                  </h3>
                  <p className="text-gray-400 text-sm leading-relaxed mb-8 border-l-2 border-gray-700 pl-4 flex-grow group-hover:border-red-500/50 transition-colors">
                      {item.description}
                  </p>
                  ...
                  <div className="mt-auto pt-4 border-t border-white/5">
                    <Button
                        variant="ghost"
                        className="w-full flex justify-between items-center border border-white/20 hover:bg-white text-white hover:text-black font-mono text-xs uppercase tracking-widest py-3 group/btn"
                        data-nt-ut-event='click'
                        data-nt-ut-category='Solutions'
                        data-nt-ut-label={item.title}
